            ...
            <div className="w-full flex flex-col items-center gap-6">
              ...
              <div className="w-full">
                <label className="block text-sm font-medium text-slate-400 mb-2">
                  Animation Prompt (Describe the motion)
                </label>
                <textarea
                  value={prompt}
                  onChange={(e) => setPrompt(e.target.value)}
                  placeholder="e.g., camera zooming in, ocean waves crashing, person smiling..."
                  className="w-full bg-slate-700 border border-slate-600 rounded-lg p-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all resize-none h-24"
                />
              </div>
